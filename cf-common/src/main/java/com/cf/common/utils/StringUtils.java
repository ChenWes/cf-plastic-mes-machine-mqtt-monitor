...
import com.cf.common.core.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String toUnderScoreCase(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            boolean isAddSeparator = (preCharIsUpperCase && curreCharIsUpperCase && !nexteCharIsUpperCase) || ((i != 0 && !preCharIsUpperCase) && curreCharIsUpperCase);
            if (isAddSeparator) {
                sb.append(SEPARATOR);
            }
     ...
     * @return
     */
    public static String toUnderlineCase(String camelStr) {
